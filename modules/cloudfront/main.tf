...
# Points to the API Gateway 
  ...
  default_cache_behavior {
    ...
    compress                   = true
    # Using AWS-documented managed policy IDs directly (avoids Terraform provider bug)
    # These IDs are stable and documented by AWS for infrastructure-as-code use
